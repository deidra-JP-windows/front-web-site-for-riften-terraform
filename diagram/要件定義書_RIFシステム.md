...
1. 業務範囲
  - サービス提供に必要な業務の範囲（運用、保守、サポート等）を明確にする。
    - 同リポジトリ シーケンス図_メンテナンスページ.md を参照
2. 業務フロー
  - 業務の流れ、各工程の役割分担、承認・報告手順等を整理する。
    - 同リポジトリ シーケンス図_メンテナンスページ.md を参照
  - CloudFrontメンテナンスページ切り替え業務フロー（詳細）
    - 同リポジトリ シーケンス図_メンテナンスページ.md を参照
    - 本業務は、AWS CloudFrontの設定をコード（IaC）で管理し、メンテナンスページと通常ページの切り替えを安全かつ確実に実施することを目的とする。
    - 役割分担：
      - コミュニティユーザ（User）：メンテナンスページ切り替えの要望を運用者へ提出
      - ページ運用者（Ops）：要望受付、管理者への申請、切り替え作業の実施、ユーザへの通知
      - 管理者（Admin）：申請内容の承認・却下判断、最終承認
      - ページ管理・開発者（Dev）：メンテナンスページのコンテンツ作成・確認、準備完了通知
    - 業務手順：
      1. コミュニティユーザがページ運用者へメンテナンスページ切り替えの要望を送付
      2. ページ運用者は要望内容を管理者へ申請
      3. 管理者は申請内容を確認し、承認または却下
      4. 承認の場合、ページ運用者はページ管理・開発者へ切り替え準備を依頼
      5. ページ管理・開発者はメンテナンスページのコンテンツを作成・確認
      6. 準備完了後、ページ管理・開発者はページ運用者へ通知
      7. ページ運用者は管理者へ最終承認申請
      8. 管理者は最終承認
      9. ページ運用者はCloudFrontの設定をコード（Terraform等）から更新し、メンテナンスページを有効化
      10. ページ運用者はコミュニティユーザへメンテナンスページ有効化を通知
      11. コミュニティユーザはメンテナンスページを確認
      12. メンテナンス終了後、ページ運用者はページ管理・開発者へ通常ページへの切り替えを依頼
      13. ページ管理・開発者は通常ページの準備完了を通知
      14. ページ運用者は管理者へ通常ページ復旧の承認申請
      15. 管理者は復旧承認
      16. ページ運用者はCloudFrontの設定をコードから更新し、通常ページを有効化
      17. ページ運用者はコミュニティユーザへ通常ページ復旧を通知
    - すべての設定変更はコード管理（IaC）で実施し、変更履歴・承認記録を残すこと。
    - 承認プロセスは二段階（初回・最終）で実施し、権限管理・監査ログ取得を徹底する。
    - 切り替え作業は、影響範囲の事前通知、ロールバック手順の整備、障害発生時の迅速な復旧を含む。
    - メンテナンスページ・通常ページのコンテンツは事前に検証・承認を受けること。
    - すべての関係者は役割分担に従い、申請・承認・通知・作業を厳格に運用する。
3. 業務体制
